    ...
    <>
      <div id="Skills" className=" bg-primary py-10">
        ...
        <div className="gap-10 md:gap-0 grid sm:grid-cols-2 md:grid-cols-3 lg:mx-40 ">
          <div className="card-1 border-b-4 border-blue-800 grid grid-cols-1 w-[220px] mx-auto p-1 rounded-xl h-96 shadow-[10px_10px_47px_rgba(30,64,175),-0px_-0px_0px_rgba(255,254,255)] hover:border-b-[5px]  hover:shadow-2xl hover:shadow-red-500 hover:scale-[1.1]">
          ...
          <div className="card-2 border-b-4 hover:border-b-[5px]  hover:shadow-2xl hover:shadow-red-500 hover:scale-[1.1] border-green-800 grid grid-cols-1 w-[220px] mx-auto p-1 rounded-xl h-96 shadow-[10px_10px_47px_rgba(22,101,52),-0px_-0px_0px_rgba(22,101,52)] ">
          ...
          <div className="card-2 border-b-4 border-fuchsia-800 grid grid-cols-1 w-[220px] mx-auto p-1 rounded-xl h-96 shadow-[10px_10px_47px_rgba(134,25,143),-0px_-0px_0px_rgba(255,254,255)] hover:border-b-[5px]  hover:shadow-2xl hover:shadow-red-500 hover:scale-[1.1]">
